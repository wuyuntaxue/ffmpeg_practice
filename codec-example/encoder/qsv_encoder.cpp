...
namespace Codec {
    ...
    int QSVEncoder::open(AVCodecID codecID, AVPixelFormat inPixel, AVBufferRef *hw_frame_ctx, int width,
    ...
    int QSVEncoder::encode(uint64_t frameid, AVFrame *inframe) {
    ...
    int QSVEncoder::flush(uint64_t frameid) {
        if (encodec_ctx_) {
